    ...
    <>
      ...
      <div style={{
        ...
        <div style={{ padding: '20px 24px 16px', borderBottom: '1px solid #2a1e3a', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexShrink: 0 }}>
          <div>
            <h2 style={{ fontFamily: "'Cinzel Decorative', serif", fontSize: '13px', letterSpacing: '0.15em', textTransform: 'uppercase', color: '#d4c5e8', margin: 0 }}>✏️ Edit Event</h2>
            <p style={{ fontFamily: "'Share Tech Mono', monospace", fontSize: '10px', color: '#8b7aa0', marginTop: '4px', letterSpacing: '0.1em' }}>Modify the details of this gathering</p>
          </div>
        ...
        <div style={{ overflowY: 'auto', flex: 1, padding: '24px' }}>
          ...
          <div style={{ marginBottom: '16px' }}>
            ...
            <textarea className="input-dark" rows={3} style={{ resize: 'none' }} value={form.description} onChange={(e) => set('description', e.target.value)} />
          </div>
