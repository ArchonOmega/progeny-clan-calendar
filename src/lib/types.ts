export type Role = 'Sovereign' | 'Priest' | 'Trainer' | 'Member'
...
export const ROLES: Role[] = ['Sovereign', 'Priest', 'Trainer', 'Member']
...
// SLT = America/Los_Angeles (Pacific Time — where Second Life servers are)
